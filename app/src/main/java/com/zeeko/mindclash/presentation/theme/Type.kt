...
// أحجام خطوط مخصصة للشاشات المختلفة
object FontSizes {
    val xs = 10.sp
    val sm = 12.sp
    val base = 14.sp
    ...
    val tabletXs = 14.sp
    val tabletSm = 16.sp
    val tabletBase = 18.sp
    val tabletLg = 20.sp
    val tabletXl = 24.sp
    val tabletXxl = 28.sp
    val tabletXxxl = 32.sp
    val tabletXxxxl = 36.sp
    val tabletXxxxxl = 40.sp
    val tabletXxxxxxl = 48.sp
}

// أوزان الخطوط المخصصة
object FontWeights {
